...
| The documentation set always lives in `docs/arc42/`, whatever the standard | [`SKILL.md`](../../SKILL.md) |
...
| CI runs the unit tests, including a verification of this documentation set, and a SkillSpector scan against a reviewed baseline on every push to `main` and every pull request | [`ci.yml`](../../.github/workflows/ci.yml), [`test_own_docs.py`](../../tests/test_own_docs.py), [`.skillspector-baseline.yaml`](../../.skillspector-baseline.yaml) |
